...
blurb: |
  Started as an AI capstone project with two ex-consultants who thought investors couldn't find infrastructure deals. After 15 interviews, turned out they were drowning in deals — just couldn't read them fast enough. We built a pipeline that does the screening in 7 minutes. 91.4% accuracy, 12x analyst capacity, one shelved project got a $220M term sheet because we freed up three analysts.
tldr: |
